...
class IntHistogramTest
{
    ...
    @Test
    public
    void orderOfGrowthTest()
    {
        System.out.format("orderOfGrowthTest -------------\n");
    ...
    {
        System.out.format("negativeRangeTest -------------\n");
    ...
    void opEqualsTest()
    {
        System.out.format("opEqualsTest -------------\n");
    ...
    @Test
    public
    void opGreaterThanTest()
    {
        System.out.format("opGreaterThanTest -------------\n");
        IntHistogram h = new IntHistogram(10, 1, 10);
    ...
    void opLessThanTest()
    {
        System.out.format("opLessThanTest -------------\n");
        IntHistogram h = new IntHistogram(10, 1, 10);
    ...
    @Test
    public
    void opGreaterThanOrEqualsTest()
    {
        System.out.format("opGreaterThanOrEqualsTest -------------\n");
        IntHistogram h = new IntHistogram(10, 1, 10);
...
//        System.out.format("h.estimateSelectivity(Op.GREATER_THAN_OR_EQ, 3): %g\n", h.estimateSelectivity(Op.GREATER_THAN_OR_EQ, 3));
    ...
    @Test
    public
    void opLessThanOrEqualsTest()
    {
        System.out.format("opLessThanOrEqualsTest -------------\n");
        IntHistogram h = new IntHistogram(10, 1, 10);
    ...
    @Test
    public
    void opNotEqualsTest()
    {
        System.out.format("opNotEqualsTest -------------\n");
        IntHistogram h = new IntHistogram(10, 1, 10);
