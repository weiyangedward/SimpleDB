 ...
 * variables used by the database system (the catalog, the
 * buffer pool, and the log files, in particular.)
 *
 * Provides a set of methods that can be used to access these
...
class Database
{
    ...
    private final Catalog    _catalog; // interface to tables
    private       BufferPool _bufferpool; // interface to bufferpool
     ...
     */
    public static
    BufferPool resetBufferPool(int pages)
    {
