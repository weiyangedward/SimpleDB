...
class HeapFile implements DbFile
{
    ...
    HeapFile(File f, TupleDesc td)
    {
        ...
        file = f;
        this.td = td;
        maxPageNo = (int)f.length() / BufferPool.PAGE_SIZE - 1;
    }
...
//        throw new UnsupportedOperationException("implement this");
    ...
    // see DbFile.java for javadocs
    public
    Page deleteTuple(TransactionId tid, Tuple t) throws DbException,
    ...
    private class FileIterator implements DbFileIterator
    {
        ...
        public boolean hasNext() throws DbException, TransactionAbortedException
        {
            ...
            if (tuples != null)
            {
                if (tuples.hasNext()) return true; // use HeapPage iterator to iterate through tuples
                /**
         ...
         */
        private void loadPage() throws DbException
        {
            try
            {
