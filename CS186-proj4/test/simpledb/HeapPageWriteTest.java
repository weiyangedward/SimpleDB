...
public
class HeapPageWriteTest extends SimpleDbTestBase
{
...
//        System.out.format("testDirty --------------\n");
    ...
    @Test
    public
    void addTuple() throws Exception
    {
        HeapPage page = new HeapPage(pid, HeapPageReadTest.EXAMPLE_DATA);
    ...
    public
    void deleteNonexistentTuple() throws Exception
    {
//        System.out.format("deleteNonexistentTuple --------------\n");
        HeapPage page = new HeapPage(pid, HeapPageReadTest.EXAMPLE_DATA);
...
//        System.out.format("deleteTuple --------------\n");
        ...
        try
        {
//            System.out.format("delete first and throw exception --------------\n");
