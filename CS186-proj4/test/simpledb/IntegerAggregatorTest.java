...
public
class IntegerAggregatorTest extends SimpleDbTestBase
{
    ...
    @Before
    public
    void createTupleList() throws Exception
    {
    ...
    @Test
    public
    void mergeSum() throws Exception
    {
//        System.out.format("mergeSum --------------\n");
        scan1.open();
    ...
    @Test
    public
    void mergeMin() throws Exception
    {
//        System.out.format("mergeMin --------------\n");
        scan1.open();
        ...
        for (int[] step : min)
        {
//            System.out.format("add new tuple ------------\n");
            agg.mergeTupleIntoGroup(scan1.next());
            it = agg.iterator();
            it.open();
            TestUtil.matchAllTuples(TestUtil.createTupleList(width1, step), it);
    ...
    @Test
    public
    void mergeMax() throws Exception
    {
//        System.out.format("mergeMax --------------\n");
        scan1.open();
    ...
    @Test
    public
    void mergeAvg() throws Exception
    {
//        System.out.format("mergeAvg --------------\n");
        scan1.open();
