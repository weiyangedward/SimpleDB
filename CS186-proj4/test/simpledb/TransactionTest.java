...
public
class TransactionTest extends TestUtil.CreateHeapFile
{
    ...
    @Test
    public
    void attemptTransactionTwice() throws Exception
    {
        System.out.format("attemptTransactionTwice ------------\n");
     ...
     */
    public
    void testTransactionComplete(boolean commit) throws Exception
    {
        System.out.format("testTransactionComplete ------------\n");
        System.out.format("tid: %s\n", tid1);
        HeapPage p = (HeapPage) bp.getPage(tid1, p2, Permissions.READ_WRITE);

        System.out.format("test page: %s\n", p);
    ...
    {
        System.out.format("commitTransaction ------------\n");
    ...
    {
        System.out.format("abortTransaction ------------\n");
