...
public
class LockingTest extends TestUtil.CreateHeapFile
{
            ...
            boolean expected) throws Exception
    {
        ...
        System.out.format("metaLockTester -------------\n");
     ...
     */
    public
    void grabLock(TransactionId tid,
                  PageId pid,
                  Permissions perm,
                  boolean expected) throws Exception
    {
        System.out.format("grabLock -------------\n");
    ...
    @Test
    public
    void acquireReadLocksOnSamePage() throws Exception
    {
        System.out.format("acquireReadLocksOnSamePage --------------\n");
    ...
    @Test
    public
    void acquireReadWriteLocksOnSamePage() throws Exception
    {
        System.out.format("acquireReadWriteLocksOnSamePage --------------\n");
        metaLockTester(tid1, p0, Permissions.READ_ONLY,
    ...
    @Test
    public
    void acquireWriteReadLocksOnSamePage() throws Exception
    {
        System.out.format("acquireWriteReadLocksOnSamePage --------------\n");
    ...
    @Test
    public
    void acquireReadWriteLocksOnTwoPages() throws Exception
    {
        System.out.format("acquireReadWriteLocksOnTwoPages --------------\n");
        metaLockTester(tid1, p0, Permissions.READ_ONLY,
    ...
    @Test
    public
    void acquireWriteLocksOnTwoPages() throws Exception
    {
        System.out.format("acquireReadWriteLocksOnTwoPages --------------\n");
        metaLockTester(tid1, p0, Permissions.READ_WRITE,
                       tid2, p1, Permissions.READ_WRITE, true
    ...
    @Test
    public
    void acquireReadLocksOnTwoPages() throws Exception
    {
        System.out.format("acquireReadLocksOnTwoPages --------------\n");
        metaLockTester(tid1, p0, Permissions.READ_ONLY,
    ...
    @Test
    public
    void lockUpgrade() throws Exception
    {
        System.out.format("lockUpgrade --------------\n");
        metaLockTester(tid1, p0, Permissions.READ_ONLY,
    ...
    @Test
    public
    void acquireWriteAndReadLocks() throws Exception
    {
        System.out.format("acquireWriteAndReadLocks --------------\n");
        metaLockTester(tid1, p0, Permissions.READ_WRITE,
    ...
    @Test
    public
    void acquireThenRelease() throws Exception
    {

        System.out.format("acquireThenRelease --------------\n");
