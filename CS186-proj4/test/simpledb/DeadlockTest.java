...
public
class DeadlockTest extends TestUtil.CreateHeapFile
{
     ...
     */
    public
    TestUtil.LockGrabber startGrabber(TransactionId tid, PageId pid, Permissions perm)
    {
    ...
    @Test
    public
    void testReadWriteDeadlock() throws Exception
    {
        System.out.println("testReadWriteDeadlock -----------");
        ...
        {
            trials --;
            System.out.format("during while loop ----------\n");
            Thread.sleep(POLL_INTERVAL);
            System.out.format("lg1Write acquired? %b\n", lg1Write.acquired());
            System.out.format("lg2Write acquired? %b\n", lg2Write.acquired());
    ...
    @Test
    public
    void testWriteWriteDeadlock() throws Exception
    {
        System.out.println("testWriteWriteDeadlock -----------");
...
//        }
    ...
    @Test
    public
    void testUpgradeWriteDeadlock() throws Exception
    {
        System.out.format("testUpgradeWriteDeadlock -----------\n");
