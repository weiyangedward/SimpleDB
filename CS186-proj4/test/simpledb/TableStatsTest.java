...
public
class TableStatsTest extends SimpleDbTestBase
{
    ...
    private
    double[] getRandomTableScanCosts(int[] pageNums, int[] ioCosts)
    throws IOException, DbException, TransactionAbortedException
    {
        System.out.format("getRandomTableScanCosts -------------------\n");
...
//            System.out.format("test table id: %d\n", tableId);
    ...
    @Test
    public
    void estimateScanCostTest() throws IOException, DbException, TransactionAbortedException
    {
        System.out.format("estimateScanCostTest -------------------\n");
        Object[] ret;
    ...
    @Test
    public
    void estimateTableCardinalityTest()
    {
        System.out.format("estimateTableCardinalityTest -------------------\n");
    ...
    @Test
    public
    void estimateSelectivityTest()
    {
        System.out.format("estimateSelectivityTest -------------------\n");
...
//            System.out.format("col: %d -----------\n", col);
            ...
            Assert.assertEquals(1.0 / 32.0, s.estimateSelectivity(col, Predicate.Op.EQUALS, halfMaxMin), 0.04);
            ...
            Assert.assertEquals(31.0 / 32.0, s.estimateSelectivity(col, Predicate.Op.NOT_EQUALS, halfMaxMin), 0.04);
            ...
            Assert.assertEquals(0.5, s.estimateSelectivity(col, Predicate.Op.GREATER_THAN, halfMaxMin), 0.13);
            ...
            Assert.assertEquals(0.5, s.estimateSelectivity(col, Predicate.Op.LESS_THAN_OR_EQ, halfMaxMin), 0.15);
            Assert.assertEquals(0.0, s.estimateSelectivity(col, Predicate.Op.LESS_THAN_OR_EQ, atMin), 0.06);
