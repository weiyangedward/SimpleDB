...
class SystemTestUtil
{
    ...
    public static
    HeapFile createRandomHeapFile(
            int columns, int rows, int maxValue,
            Map<Integer, Integer> columnSpecification,
            ArrayList<ArrayList<Integer>> tuples
                                 )
    throws IOException, DbException, TransactionAbortedException
    ...
    public static
    File createRandomHeapFileUnopened(
            int columns, int rows,
    ...
    public static
    ArrayList<Integer> tupleToList(Tuple tuple)
    {
    ...
    public static
    void matchTuples(DbFile f, List<ArrayList<Integer>> tuples)
    ...
    public static
    void matchTuples(DbFile f, TransactionId tid, List<ArrayList<Integer>> tuples)
    throws DbException, TransactionAbortedException, IOException
    {
    ...
    public static
    void matchTuples(DbIterator iterator, List<ArrayList<Integer>> tuples)
    throws DbException, TransactionAbortedException, IOException
    {
    ...
    private static
    double[] getDiff(double[] sequence)
    {
     ...
     */
    public static
    Object[] checkQuadratic(double[] sequence)
    {
     ...
     */
    public static
    Object[] checkLinear(double[] sequence)
    {
     ...
     */
    public static
    Object[] checkConstant(double[] sequence)
    {
