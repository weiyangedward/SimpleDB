 ...
 */
public
class EvictionTest extends SimpleDbTestBase
{
    ...
    @Test
    public
    void testHeapFileScanWithManyPages() throws IOException, DbException, TransactionAbortedException
    {
    ...
    public static
    void insertRow(HeapFile f, Transaction t) throws DbException,
    ...
    public static
    boolean findMagicTuple(HeapFile f, Transaction t)
