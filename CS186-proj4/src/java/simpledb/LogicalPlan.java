...
//    private Query owner;
     ...
     */
    public
    Integer getTableId(String alias)
    {
        return tableMap.get(alias);
    }

    public
    HashMap<String, Integer> getTableAliasToIdMapping()
    {
     ...
     */
    public
    void addFilter(String field, Predicate.Op p, String constantValue) throws ParsingException
    {
    ...
    public
    void addJoin(String joinField1, String joinField2, Predicate.Op pred) throws ParsingException
    {
     ...
     */
    public
    void addJoin(String joinField1, DbIterator joinField2, Predicate.Op pred) throws ParsingException
    {
        joinField1 = disambiguateName(joinField1);
     ...
     *
     * @param table the id of the table accessed by the plan (can be resolved to a DbFile using
     *              {@link Catalog#getDbFile}
     * @param name  the alias of the table in the plan
     */

    public
    void addScan(int table, String name)
    {
     ...
     */
    public
    void addProjectField(String fname, String aggOp) throws ParsingException
    {
     ...
     */
    public
    void addAggregate(String op, String afield, String gfield) throws ParsingException
    {
     ...
     */
    public
    void addOrderBy(String field, boolean asc) throws ParsingException
    {
        field = disambiguateName(field);
        oByField = field;
        oByAsc = asc;
...
//                int id = 
                ...
                else
                {
                    throw new ParsingException("Field " + name
                                               + " appears in multiple tables; disambiguate by referring to it as "
                                               + "tablename."
                                               + name);
                }
            }
     ...
     */
    static
    Aggregator.Op getAggOp(String s) throws ParsingException
    {
        s = s.toUpperCase();
    ...
    /**
     * Convert this LogicalPlan into a physicalPlan represented by a {@link DbIterator}.
     * Attempts to find the optimal plan by using {@link JoinOptimizer#orderJoins} to order the
     * joins in the plan.
     *
    ...
    DbIterator physicalPlan(
            TransactionId t,
            Map<String, TableStats> baseTableStats,
            boolean explain)
    throws ParsingException
    {
        Iterator<LogicalScanNode>   tableIt             = tables.iterator();
