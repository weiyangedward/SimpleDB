...
class QueryPlanVisualizer
{
    ...
    private
    int calculateQueryPlanTreeDepth(DbIterator root)
    {
        if (root == null)
        { return 0; }
    ...
    private
    SubTreeDescriptor buildTree(
            int queryPlanDepth, int currentDepth,
...
//            TupleDesc td = s.getTupleDesc();
    ...
    private
    void printTree(SubTreeDescriptor root, char[] buffer, int width)
    {
        if (root == null)
        { return; }
    ...
    public
    String getQueryPlanTree(DbIterator physicalPlan)
    {
    ...
    public
    void printQueryPlanTree(DbIterator physicalPlan, PrintStream out)
    {
        if (out == null)
        { out = System.out; }
