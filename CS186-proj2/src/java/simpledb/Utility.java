...
/**
 * Helper methods used for testing and implementing random
 * features.
 */
public
class Utility
{
     ...
     */
    public static
    String[] getStrings(int len, String val)
    {
     ...
     */
    public static
    TupleDesc getTupleDesc(int n, String name)
    {
     ...
     */
    public static
    Tuple getHeapTuple(int[] tupdata)
    {
     ...
     */
    public static
    Tuple getHeapTuple(int n, int width)
    {
     ...
     */
    public static
    Tuple getTuple(int[] tupledata, int width)
    {
     ...
     */
    public static
    HeapFile createEmptyHeapFile(String path, int cols)
    throws IOException
    {
     ...
     */
    public static
    HeapFile openHeapFile(int cols, File f)
    {
    ...
    public static
    HeapFile openHeapFile(int cols, String colPrefix, File f)
    {
        // create the HeapFile and add it to the catalog
