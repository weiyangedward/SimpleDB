...
class ScanTest extends SimpleDbTestBase
{
     ...
     */
    private
    void validateScan(int[] columnSizes, int[] rowSizes)
    ...
    @Test
    public
    void testSmall() throws IOException, DbException, TransactionAbortedException
    {
    ...
    @Test
    public
    void testRewind() throws IOException, DbException, TransactionAbortedException
    {
        ArrayList<ArrayList<Integer>> tuples = new ArrayList<ArrayList<Integer>>();
    ...
    @Test
    public
    void testCache() throws IOException, DbException, TransactionAbortedException
    {
        /** Counts the number of readPage operations. */
        class InstrumentedHeapFile extends HeapFile
        {
            public
            InstrumentedHeapFile(File f, TupleDesc td)
            {
                super(f, td);
            }
            ...
            @Override
            public
            Page readPage(PageId pid) throws NoSuchElementException
            {
                readCount += 1;
        ...
        final int                     PAGES  = 30;
        ArrayList<ArrayList<Integer>> tuples = new ArrayList<ArrayList<Integer>>();
        File                          f      = SystemTestUtil.createRandomHeapFileUnopened(
                1, 992 * PAGES, 1000, null, tuples);
